...
[[group(0), binding(2)]] var<storage, read> colors: Buffer;
[[group(0), binding(3)]] var<storage, write> cloud_sorted: Buffer;
[[group(0), binding(4)]] var<storage, write> colors_sorted: Buffer;
...
fn main([[builtin(global_invocation_id)]] global : vec3<u32>) {
	...
	colors_sorted.data[idx] = colors.data[id];
}
